                ...
                for ii in range(x.shape[1]):
                    ...
                    x_t = nn.ReLU()(
                        nn.BatchNorm1d(self.keypoint_hidden_dim * (self.num_heads if self.attention else 1)).to(device)(
                            x_t))
                    x_t, new_edge_index, _, _, _ = self.pool1(x_t, new_edge_index)
                    ...
                    x_t = nn.ReLU()(
                        nn.BatchNorm1d(self.keypoint_hidden_dim * (self.num_heads if self.attention else 1)).to(device)(
                            x_t))
                    x_t, new_edge_index, _, _, _ = self.pool2(x_t, new_edge_index)
                    ...
                    x_t, new_edge_index, _, _, _ = self.pool3(x_t, new_edge_index)
