...
import copy as cp
from DGSTGCN.utils import dggcn, dgmstcn, unit_tcn, cache_checkpoint
from DGSTGCN.graph import Graph
...
class DGBlock(nn.Module):
    ...
    def __init__(self, num_point, in_channels, out_channels, A, stride=1, residual=True, **kwargs):
        super().__init__()
        ...
        self.tcn = dgmstcn(out_channels, out_channels, stride=stride, num_joints=num_point, **tcn_kwargs)
...
class Model(nn.Module):
    ...
    def __init__(self,
        ...
        if self.in_channels != self.base_channels:
            modules = [
                DGBlock(self.num_point, in_channels, base_channels, A.clone(), 1, residual=False, **lw_kwargs[0])]
        ...
        for i in range(2, num_stages + 1):
            ...
            modules.append(DGBlock(self.num_point, in_channels, out_channels, A.clone(), stride, **lw_kwargs[i - 1]))
